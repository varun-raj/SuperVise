...
class BatchesControllerTest < ActionController::TestCase
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post :create, batch: { end_year: @batch.end_year, start_year: @batch.start_year, title: @batch.title }
    end
  ...
  test "should update batch" do
    patch :update, id: @batch, batch: { end_year: @batch.end_year, start_year: @batch.start_year, title: @batch.title }
    assert_redirected_to batch_path(assigns(:batch))
  end
